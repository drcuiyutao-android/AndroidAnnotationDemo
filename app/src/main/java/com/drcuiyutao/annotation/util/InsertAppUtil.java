...
import com.drcuiyutao.annotation.demo.MainActivity;
...
public class InsertAppUtil {
    ...
    @Insert(target = MainActivity.class, name = "TEST_STR")
    public static final String TEST_STR = "success";

    @Insert(target = MainActivity.class, name = "TEST_INITIALED_STR")
    public static final String TEST_INITIALED_STR = "success";

    @Insert(target = MainActivity.class, name = "TEST_BOOLEAN")
    public static final boolean TEST_BOOLEAN = true;

    @Insert(target = MainActivity.class, replace = true)
